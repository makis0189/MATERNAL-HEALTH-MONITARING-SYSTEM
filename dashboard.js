            ...
            tr.innerHTML = `
                ...
                <td>
                    <button class="action-btn delete-btn" onclick="deletePatient(${patient.id})">
                     ...
                     <button class="action-btn delete-btn" onclick="editPatient(${patient.id})" style="color:#007bff">
    ...
    function renderAppointmentRows(rows) {
        ...
        rows.forEach(row => {
            ...
            tr.innerHTML = `
                ...
                <td>
                    <button class="action-btn delete-btn" onclick="deleteAppointment(${row.id})">
                        <i class="fa-solid fa-trash"></i>
                    </button>

                    <button class="action-btn delete-btn" onclick="editApointment(${row.id})" style="color:#007bff">
                        <i class="fa-solid fa-edit"></i>
                    </button>
                </td>
            `;
    ...
    function renderAncRows(rows) {
        ...
        rows.forEach(row => {
            ...
            tr.innerHTML = `
                ...
                <td>
                    <button class="action-btn delete-btn" onclick="deleteAnc(${row.id})">
                        <i class="fa-solid fa-trash"></i>
                    </button>

                    <button class="action-btn delete-btn" onclick="editAnc(${row.id})" style="color:#007bff">
                        <i class="fa-solid fa-edit"></i>
                    </button>
                </td>
            `;
    ...
    function renderPncRows(rows) {
        ...
        rows.forEach(row => {
            ...
            tr.innerHTML = `
                ...
                <td>
                    <button class="action-btn delete-btn" onclick="deletePnc(${row.id})">
                        <i class="fa-solid fa-trash"></i>
                    </button>

                    <button class="action-btn delete-btn" onclick="editPnc(${row.id})" style="color:#007bff">
                        <i class="fa-solid fa-edit"></i>
                    </button>
                </td>
            `;
    ...
    function renderImmunizationRows(rows) {
        ...
        rows.forEach(row => {
            ...
            tr.innerHTML = `
                ...
                <td>${escapeHTML(row.status)}</td>
                <td>
                    <button class="action-btn delete-btn" onclick="deleteImmunization(${row.id})">
                        <i class="fa-solid fa-trash"></i>
                    </button>

                    <button class="action-btn delete-btn" onclick="editImmunization(${row.id})" style="color:#007bff">
                        <i class="fa-solid fa-edit"></i>
                    </button>
                </td>
            `;
    ...
    function renderHighRiskRows(rows) {
        ...
        rows.forEach(row => {
            ...
            tr.innerHTML = `
                ...
                <td>${escapeHTML(row.status)}</td>
                <td>
                    <button class="action-btn delete-btn" onclick="deleteHighRisk(${row.id})">
                        <i class="fa-solid fa-trash"></i>
                    </button>

                    <button class="action-btn delete-btn" onclick="editHighRisk(${row.id})" style="color:#007bff">
                        <i class="fa-solid fa-edit"></i>
                    </button>
                </td>
            `;
                    ...
                    rows.forEach(row => {
                        ...
                        tr.innerHTML = `
                            ...
                            <td>
                                ...
                                <button class="action-btn delete-btn" onclick="editMessage(${row.id})" style="color:#007bff">
                                    <i class="fa-solid fa-edit"></i>
                                </button>
                            </td>
                        `;
                ...
                if (resData.status === "success") {
                    ...
                    rows.forEach(row => {
                        ...
                        tr.innerHTML = `
                            ...
                            <td>${escapeHTML(row.created_at ?? "")}</td>
                            <td>
                                <button class="action-btn delete-btn" onclick="deleteEducation(${row.id})">
                                    <i class="fa-solid fa-trash"></i>
                                </button>

                                <button class="action-btn delete-btn" onclick="editEducation(${row.id})" style="color:#007bff">
                                    <i class="fa-solid fa-edit"></i>
                                </button>
                            </td>
                        `;
        ...
        rows.forEach(row => {
            ...
            tr.innerHTML = `
                ...
                <td>
                    ...
                    <button class="action-btn delete-btn" onclick="editUser(${row.id})" style="color:#007bff">
                        <i class="fa-solid fa-edit"></i>
                    </button>
                </td>
            `;
