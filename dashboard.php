...
<h1>Dashboard</h1>
<p style="background:#603fd9; color:white; padding:10px; border-radius:5px; height:60px; align-items: center;">Welcome back, <?php echo htmlspecialchars($_SESSION['user_name']); ?>! <span style="color:#888; font-size:0.85em;">(<?php echo htmlspecialchars(currentRole()); ?>)</span></p>
<div class="cards">
<div class="card">
<i class="fa-solid fa-bed-pulse"></i>
