...
<h1>Dashboard</h1>
<p style="background:#603fd9; color:white; padding:10px; border-radius:5px; height:70px; justify-content: center; align-items:center; display: flex; font-zise:15px;">Welcome back, <?php echo htmlspecialchars($_SESSION['user_name']); ?>! <span style="color:white; font-size:25px; margin-left: auto; background:#0d9488; border-radius:15px; padding:10px;"><?php echo htmlspecialchars(currentRole()); ?></span></p>
<div class="cards">
<div class="card">
<i class="fa-solid fa-bed-pulse"></i>
