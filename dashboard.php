...
<h1>Dashboard</h1>
<p style="background:#603fd9; color:white; padding:10px; border-radius:5px; height:60px; justify-content: center; display: flex;">Welcome back, <?php echo htmlspecialchars($_SESSION['user_name']); ?>! <span style="color:white; font-size:30px; margin-left: auto;">(<?php echo htmlspecialchars(currentRole()); ?>)</span></p>
<div class="cards">
<div class="card">
<i class="fa-solid fa-bed-pulse"></i>
